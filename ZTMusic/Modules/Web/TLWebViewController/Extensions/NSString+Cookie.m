...
@implementation NSHTTPCookie (CookieString)

@dynamic stringValue;
@dynamic expireStringValue;

- (NSString *)stringValue {
    NSString *string = [NSString stringWithFormat:@"%@=%@;expiresDate=%@;path=%@;sessionOnly=%@;isSecure=%@;domain=%@",
                        self.name,
                        self.value,
                        self.expiresDate,
                        self.path ?: @"/",
